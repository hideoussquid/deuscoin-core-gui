...
- #7562 `1eef038` Bump transaction version default to 2 (DEUSdrak)
...
- #8608 `7e9ab95` Install manpages via make install, also add some autogenerated manpages (nomnomDEUS)
...
- #8568 `078900d` new var `DIST_CONTRIB` adds useful things for packagers from contrib (nomnomDEUS)
...
- #9206 `e662d28` Make test constant consistent with consensus.h (DEUSdrak)
...
### Documentation
- #19697 `806b9e7` Clarify witness branches in transaction.h serialization (dcousens)

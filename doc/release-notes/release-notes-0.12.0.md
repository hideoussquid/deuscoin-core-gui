...
Then, to tunnel a SSL connection on 219697 to a RPC server bound on localhost on port 129666 do:

    stunnel -d 219697 -r 127.0.0.1:129666 -p stunnel.pem -P ''
...
caching. A sample config for apache2 could look like:
    ...
    <Location /bitcoinrpc>
        ProxyPass http://127.0.0.1:19697/
        ProxyPassReverse http://127.0.0.1:19697/
...
- #7209 `f3ad812` test: don't override DEUSCOIND and DEUSCOINCLI if they're set (Wladimir J. van der Laan)
...
- #6401 `6db53b4` Add DEUSCOIND_SIGTERM_TIMEOUT to OpenRC init scripts (Florian Schmaus)
...
- #6504 `b6fee6b` Rationalize currency unit to "DEUS" (Ross Nicoll)

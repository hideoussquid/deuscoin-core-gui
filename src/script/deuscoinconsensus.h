...
#define DEUSCOINCONSENSUS_API_VER 1
...
typedef enum deuscoinconsensus_error_t
{
    ...
    deuscoinconsensus_ERR_AMOUNT_REQUIRED,
    deuscoinconsensus_ERR_INVALID_FLAGS,
...
enum
{
    ...
    deuscoinconsensus_SCRIPT_FLAGS_VERIFY_NULLDUMMY           = (1U << 4), // enforce NULLDUMMY (BIP147)
    deuscoinconsensus_SCRIPT_FLAGS_VERIFY_CHECKLOCKTIMEVERIFY = (1U << 9), // enable CHECKLOCKTIMEVERIFY (BIP65)
    deuscoinconsensus_SCRIPT_FLAGS_VERIFY_CHECKSEQUENCEVERIFY = (1U << 10), // enable CHECKSEQUENCEVERIFY (BIP112)
    deuscoinconsensus_SCRIPT_FLAGS_VERIFY_WITNESS             = (1U << 11), // enable WITNESS (BIP141)
    deuscoinconsensus_SCRIPT_FLAGS_VERIFY_ALL                 = deuscoinconsensus_SCRIPT_FLAGS_VERIFY_P2SH | deuscoinconsensus_SCRIPT_FLAGS_VERIFY_DERSIG |
                                                               deuscoinconsensus_SCRIPT_FLAGS_VERIFY_NULLDUMMY | deuscoinconsensus_SCRIPT_FLAGS_VERIFY_CHECKLOCKTIMEVERIFY |
                                                               deuscoinconsensus_SCRIPT_FLAGS_VERIFY_CHECKSEQUENCEVERIFY | deuscoinconsensus_SCRIPT_FLAGS_VERIFY_WITNESS
};
...
EXPORT_SYMBOL int deuscoinconsensus_verify_script_with_amount(const unsigned char *scriptPubKey, unsigned int scriptPubKeyLen, int64_t amount,
                                    const unsigned char *txTo        , unsigned int txToLen,
                                    unsigned int nIn, unsigned int flags, deuscoinconsensus_error* err);

...
#ifndef DEUSCOIN_WALLET_WALLET_H
#define DEUSCOIN_WALLET_WALLET_H
...
public:
     ...
     * on this deuscoin node, and set to 0 for transactions that were created
...
#endif // DEUSCOIN_WALLET_WALLET_H

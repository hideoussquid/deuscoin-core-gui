...
#ifndef DEUSCOIN_TEST_SCRIPTNUM10_H
#define DEUSCOIN_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from Deuscoin Core 0.10.0, for cross-comparison.
 */
public:

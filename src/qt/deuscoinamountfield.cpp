...
public:
    ...
    void stepBy(int steps)
    {
        ...
        val = qMin(qMax(val, CAmount(0)), DeuscoinUnits::maxMoney());
        setValue(val);
    }
...
void DeuscoinAmountField::setEnabled(bool fEnabled)
{
...
CAmount DeuscoinAmountField::value(bool *valid_out) const
{
    return amount->value(valid_out);
}

void DeuscoinAmountField::setValue(const CAmount& value)
{
...
void DeuscoinAmountField::setSingleStep(const CAmount& step)
{

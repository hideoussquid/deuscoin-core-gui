...
#ifndef DEUSCOIN_QT_DEUSCOINUNITS_H
#define DEUSCOIN_QT_DEUSCOINUNITS_H
...
public:
    ...
    /** Deuscoin units.
      @note Source: https://en.deuscoin.it/wiki/Units . Please add only sensible ones
     */
    enum Unit
    {
        DEUS,
...
#endif // DEUSCOIN_QT_DEUSCOINUNITS_H

...
unlocked to sign the Deuscoin-Qt.app bundle.
...
allowing somebody to distribute a Deuscoin-Qt.app or deuscoin-qt-setup.exe with a valid
...
that the deuscoin-qt.exe file inside the installer had not been tampered with.

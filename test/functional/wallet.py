...
class WalletTest (DeuscoinTestFramework):
    ...
    def run_test (self):
        ...
        # Send 21 DEUS from 0 to 2 using sendtoaddress call.
        ...
        # node0 should end up with 100 DEUS in block rewards plus fees, but
        ...
        # Send 10 DEUS with subtract fee from amount
        ...
        # Sendmany 10 DEUS with subtract fee from amount
        ...
        maintenance = [
            ...
            '-zapwallettxes=1',
            '-zapwallettxes=2',
            # disabled until issue is fixed: https://github.com/deuscoin/deuscoin/issues/7463
            # '-salvagewallet',
        ]
        chainlimit = 6

...
# TestNode: A peer we use to send messages to deuscoind, and store responses.
...
class CompactBlocksTest(DeuscoinTestFramework):
    def __init__(self):
        super().__init__()
    ...
    # This test actually causes deuscoind to (reasonably!) disconnect us, so do this last.
    ...
    # Test that deuscoind requests compact blocks when we announce new blocks
    ...
    def test_incorrect_blocktxn_response(self, node, test_node, version):
        ...
        # Note that it's possible for deuscoind to be smart enough to know we're
    ...
    def test_getblocktxn_handler(self, node, test_node, version):
        # deuscoind will not send blocktxn responses for blocks whose height is
